...
<head>
    ...
    <title>Registrar usuario &mdash; TecnoSoluciones</title>
...
<div class="app-layout">
    ...
    <div class="app-content">
        ...
        <main class="container">
            ...
            <div class="form-card">
                <form action="index.php?accion=usuario_guardar" method="POST">

                    <div class="form-row">
                        <div class="form-group">
                            <label for="nombre">Nombre <span class="required">*</span></label>
                            <input type="text" id="nombre" name="nombre" value="<?php echo h($datos["nombre"] ?? ""); ?>" required maxlength="80" placeholder="Ej: Juan">
                        </div>

                        <div class="form-group">
                            <label for="ape_pat">Apellido paterno <span class="required">*</span></label>
                            <input type="text" id="ape_pat" name="ape_pat" value="<?php echo h($datos["ape_pat"] ?? ""); ?>" required maxlength="80" placeholder="Ej: Pérez">
                        </div>

                        <div class="form-group">
                            <label for="ape_mat">Apellido materno <span class="required">*</span></label>
                            <input type="text" id="ape_mat" name="ape_mat" value="<?php echo h($datos["ape_mat"] ?? ""); ?>" required maxlength="80" placeholder="Ej: González">
                        </div>
                    </div>
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <input type="text" id="dni" name="dni" value="<?php echo h($datos["dni"] ?? ""); ?>" required minlength="8" maxlength="8" pattern="[0-9]{8}" placeholder="12345678">
                        </div>

                        <div class="form-group">
                            <label for="usuario">Usuario <span class="required">*</span></label>
                            <input type="text" id="usuario" name="usuario" value="<?php echo h($datos["usuario"] ?? ""); ?>" required minlength="4" maxlength="50" placeholder="juan.perez">
                        </div>
