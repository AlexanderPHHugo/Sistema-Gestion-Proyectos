            ...
            <div class="form-card">
                <form action="index.php?accion=registrar" method="POST">
                    ...
                    <div class="form-actions">
                        ...
                        <a class="button button-secondary" href="index.php?accion=menu">
                            Cancelar
                        </a>
                    </div>
